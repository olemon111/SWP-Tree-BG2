...
auto make_segmentation(RandomIt first, RandomIt last, size_t epsilon) {
    using uint64_t = typename RandomIt::value_type;
    using canonical_segment = typename OptimalPiecewiseLinearModel<uint64_t, size_t>::CanonicalSegment;
    using pair_type = typename std::pair<uint64_t, size_t>;
